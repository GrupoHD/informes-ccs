...
export default function LoginPage() {
  ...
  async function handleLogin() {
    ...
    try {
      ...
      setError('No se pudo iniciar sesión. Asegúrese de usar su cuenta corporativa.')
    } finally {
      setBusy(false)
    }
  }
  ...
  return (
    <div className="login-page">
      <div className="login-card">
        ...
        <p>Inicia sesión con tu cuenta corporativa de Google para acceder al sistema de reportes de turno.</p>
